...
SCENARIO("generic_type_index", "[core][java_types]")
{
          ...
          "and parameters X, value, Z")
  {
    ...
    WHEN("Looking for parameter indexes")
    {
      ...
      const auto index_value = generic_struct_tag_type.generic_type_index(value);
  ...
  GIVEN("HashMap<K,V> extends Map<K,V>, and parameters K, V, T")
  {
    ...
    WHEN("Looking for parameter indexes")
    {
      const auto index_param0 = generic_struct_tag_type.generic_type_index(param0);
      const auto index_param1 = generic_struct_tag_type.generic_type_index(param1);
      const auto index_param2 = generic_struct_tag_type.generic_type_index(param2);
